...
I'm a Software Engineer with experience across prompt engineering,  product management, and UI/UX design. 

I am versed in `Python`, `HTML`, `Java`,` SQL`,` Javascript`,` C`, and `C++`. Some of my most often use libraries are `NumPY`,` Pandas` and `TensorFlow`. 

Here's what I believe creates a great Software Engineer:
